...
namespace GetChamps
{
    public class apiLinks
    {
        ...
        //root
        public const string root = "https://na1.api.riotgames.com/";
        ...
        //Summoner links
        public const string summaryURL = "/v3/stat/by-summoner/{0}/summary";
        public const string summonerNameURL = "lol/summoner/v3/summoners/by-name/{0}";
        public const string summonerMasteryURL = "/v3/summoners/{0}/masteries";
        public const string summonerRunesURL = "/v3/summoners/{0}/runes";
